...
* **Smart Application:** Streamlines the process of applying to positions once your CV is optimized.
...
1. **Clone the repository:**
   ```bash
  git clone https://github.com/sarvani08puli-create/CortexHire.git
  cd CortexHire
   ```
...
3. **Set up your environment variables:**
   ...
   ```
docs: It is still in the initial state
